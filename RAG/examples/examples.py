...
def get_examples(user_input):
    ...
    most_relevant_example = retriever.get_relevant_documents(user_input)
    ...
    for example in examples_temp:
        if example["index"] == most_relevant_example["index"]:
            continue
    ...
    return user_examples, most_relevant_example.metadata["type"]
