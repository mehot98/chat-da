...
# 언어 모델 로드
llm = ChatOpenAI(model="davinci-002", temperature=0, verbose=True)

# 언어 모델 로드 with Stream
llm_stream = ChatOpenAI(model="davinci-002", temperature=0, verbose=True, streaming=True,)
...
#     res = get_output(user_input='베버리지 존이 뭐야', search=False)
