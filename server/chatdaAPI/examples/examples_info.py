...
examples = [
    {
        ...
        "query": ("SELECT * FROM 'refridgerators'"
                  ...
                  " WHERE 'refridgerators'.`제품_코드`='RF85C90D1AP';\n\n"
                  f"{join} WHERE 'refridgerators'.`제품_코드`='RF85C90D1AP';"),
        "type": INFO,
        "index": 0
    },
    {
        "input": "BESPOKE 냉장고 4도어 제품에 대해 설명해줘",
        "query": ("SELECT * FROM 'refridgerators' WHERE `제품명` LIKE '%BESPOKE 냉장고 4도어%';\n\n"
                  f"{join} WHERE 'refridgerators'.`제품명` LIKE '%BESPOKE 냉장고 4도어%';"),
        "type": INFO,
        "index": 1
    },
    {
